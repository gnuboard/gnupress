...
function g5_editor_html($id, $content, $placeholder='')
{
    $textarea = apply_filters('g5_textarea_editor_html', "<textarea id=\"$id\" name=\"$id\" style=\"width:100%;\" $placeholder >$content</textarea>", $id, $content );
    return $textarea;
}
